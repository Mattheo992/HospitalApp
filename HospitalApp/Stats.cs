        ...
        get
        {
            switch (this.Averange)
            {
                case var averange when averange >= 80:
                    return "POMOC NATYCHMIASTOWA!";
                case var averange when averange >= 60:
                    return "POMOC BARDZO PILNA!";
                case var averange when averange >= 40:
                    return "POMOC PILNA - DO 60 MINUT";
                case var averange when averange >= 20:
                    return "POMOC ODROCZONA - DO 120 MINUT";
                case var averange when averange > 20:
                    return "PACJENT WYCZEKUJĄCY - DO 240 MINUT";
